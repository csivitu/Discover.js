const ContactUs = () => {
    return (
      <footer
        id="ContactUs"
        className="text-sm sm:text-base w-full pt-10 sm:pt-20 pb-5 relative items-center justify-evenly bg-darkgray"
      >
        <div className="flex flex-col p-4 sm:flex-row justify-around text-white mb-10">
          ...
          <div className="flex flex-col">
            <div className="flex flex-col items-start sm:items-end mb-2">
              ...
              <div className="flex justify-end gap-2">
                <p className="m-0 whitespace-nowrap mb-2 font-medium">Email: </p>
                <a
                  target="_blank"
                  rel="noreferrer"
