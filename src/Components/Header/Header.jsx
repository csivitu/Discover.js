...
const Header = () => {
  function toggle(){
    if (document.getElementById("menu").className == 'text-white text-2xl text-yellow lg:hidden translate-x-0'){
      document.getElementById("menu").className = 'text-white text-2xl text-yellow lg:hidden -translate-x-full';
      console.log("hha");
    }
    else{
      document.getElementById("menu").className = 'text-white text-2xl text-yellow lg:hidden translate-x-0';
      console.log("hje")
    }
  }
  return (
    <section>
        <header>
            <div className='container mx-auto lg:px-20 px-5 py-16 justify-between flex'>
                <div>
                  <img src={csi} className="w-100% pt-2" alt="logo" />
                </div>
            ...
            <div id = "menu" className='text-white text-2xl text-yellow lg:hidden -translate-x-full'>
              <ul className='flex flex-col items-center text-yellow'>
                <li><a className ='hover:text-sky-50 duration-500' href="#home">Home</a></li>
