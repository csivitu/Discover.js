    ...
    <section>
        <header>
            <div className='container mx-auto lg:px-20 px-5 py-16 justify-between flex'>
                <a target="_blank" href="https://csivit.com" rel="noreferrer">
                  <img src="https://csivitu.github.io/static-files/images/ccs/CSI_logo_Light.png" className="pt-2 h-10" alt="logo" />
                </a>
            ...
            <div id = "menu" className='text-white text-xl lg:hidden -translate-x-full h-0 transition-all ease-in-out duration-100'>
